      ...
      <div className="footer-inner">
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <p>
              <a href="tel:+905458334925" className="footer-phone-link">+90 545 833 49 25</a>
            </p>
            <p>
              <a href="tel:+905388959661" className="footer-phone-link">+90 538 895 96 61</a>
            </p>
          </div>
        </div>
